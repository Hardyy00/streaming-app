...
export const Thumbnail: React.FC<ThumbnailProps> = ({
  ...
  if (!src) {
    console.log(src);
    content = (
      <div className="bg-background flex flex-col items-center justify-center gap-y-4 h-full w-full transition-transform group-hover:translate-x-2 group-hover:-translate-y-1 rounded-xl"></div>
    );
  }
  return (
